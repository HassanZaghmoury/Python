...
def show(request):
    ...
    return render(request, "first_app/show.html", db_dict)
...
def travels(request):
    ...
    return render(request, "first_app/travels.html", db_dict)


def new_trip(request):
    return render(request, "first_app/new_trip.html")
